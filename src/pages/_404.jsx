  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col justify-center items-center px-4">
      <div className="text-center max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-8xl font-bold text-transparent bg-gradient-to-r from-rose-600 to-red-700 bg-clip-text mb-4">
            404
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
		  ...
		  href="/"
            ...
            className="inline-flex items-center px-6 py-3 border-2 border-rose-600 text-rose-600 font-semibold rounded-lg hover:bg-rose-600 hover:text-white transition-all duration-300 transform hover:scale-105"
          >
