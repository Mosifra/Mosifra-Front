    ...
    <>
      <main className="min-h-screen bg-beige-mosifra">
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="mb-16">
            <h1 className="text-5xl font-bold text-vert-mosifra mb-2">{t("university.home.welcome", { name: universityName }, `Bienvenue, ${universityName}`)}</h1>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-md p-8 border-l-4 border-vert-mosifra hover:shadow-lg transition-all transform duration-300">
              <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-vert-mosifra mb-2">{t("university.home.internshipsTitle", null, "Voir les offres de stage")}</h2>
                <p className="text-gray-600">
                  {t("university.home.internshipsDescription", null, "Consultez la liste des stages mis à disposition par les entreprises.")}
                </p>
              </div>
              <button
              ...
              >
                {t("university.home.internshipsAccess", null, "Accéder")}
              </button>
            </div>
            <div className="bg-white rounded-xl shadow-md p-8 border-l-4 border-vert-mosifra hover:shadow-lg transition-all transform duration-300">
              <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-vert-mosifra mb-2">{t("university.home.studentsTitle", null, "Gérer les étudiants")}</h2>
                <p className="text-gray-600">
                  {t("university.home.studentsDescription", null, "Gérer vos promotions et la liste des étudiants.")}
                </p>
              </div>
              <button
              ...
              >
                {t("university.home.studentsAccess", null, "Accéder")}
              </button>
            </div>
          </div>
        </div>
